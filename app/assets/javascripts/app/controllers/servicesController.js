...
function ServiceEditCtrl($scope, $rootScope, $routeParams, $location, Service, EnvironmentsService, MockGroupsService, UIService) {
    ...
    Service.get({serviceId: $routeParams.serviceId}, function (service) {
        ...
        $scope.service.recordContentData = UIService.fixBooleanReverse($scope.service.recordContentData);
...
function ServiceNewCtrl($scope, $rootScope, $location, $routeParams, Service, MockGroupsService, EnvironmentsService, UIService) {
    ...
    $scope.service.recordContentData = "yes";
